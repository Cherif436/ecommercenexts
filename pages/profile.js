...
function Profile() {
  ...
  const submitHandler = async ({ name, email, password, confirmPassword }) => {
    ...
    try {
      ...
      enqueueSnackbar('Mise à jour du profil réussie', { variant: 'success' });
    } catch (err) {
            ...
            <List>
              <NextLink href="/profile" passHref>
                <ListItem selected button component="a">
                  <ListItemText primary="Profil utilisateur"></ListItemText>
                </ListItem>
              </NextLink>
              <NextLink href="/order-history" passHref>
                <ListItem button component="a">
                  <ListItemText primary="Historique des commmandes"></ListItemText>
                </ListItem>
              </NextLink>
            </List>
          </Card>
                      ...
                      <Controller
                        ...
                        rules={{
                          validate: (value) =>
                            value === '' ||
                            value.length > 5 ||
                            'Confirmer la longueur du mot de passe est supérieure à 5',
                        }}
                        render={({ field }) => (
                          <TextField
                            variant="outlined"
