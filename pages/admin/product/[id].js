  ...
  const submitHandler = async ({ name, slug, price, category, image, featuredImage, brand, countInStock, description }) => {
    ...
    try {
      ...
      await axios.put(
        ...
        { name, slug, price, category, image, isFeatured, featuredImage, brand, countInStock, description },
        { headers: { authorization: `Bearer ${userInfo.token}` } }
      );
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={errors.slug ? '* Slug requis' : ''}
                            {...field}
                          ></TextField>
                        )}
                      ></Controller>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={errors.image ? '* Image requise' : ''}
                            {...field}
                          ></TextField>
                        )}
                      ></Controller>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={errors.brand ? '* Marque requise' : ''}
                            {...field}
                          ></TextField>
                        )}
                      ></Controller>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            fullWidth
                            id="countInStock"
                            label="Compter en stock"
                            error={Boolean(errors.countInStock)}
                            helperText={
                              errors.countInStock
                                ? '* Compte en stock est requis'
                                : ''
                            }
                            {...field}
                          ></TextField>
